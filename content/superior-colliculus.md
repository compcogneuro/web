...
One of the most well-studied aspects of SC functionality is in driving eye movements (saccades) toward spatial targets. The retinotopically-organized **superficial layers** of the SC receive direct input from the retina and visual areas of neocortex, and project into the **intermediate** and **deep** layers that contain motor output neurons that directly drive eye movements. These deeper layers receive extensive input from the SNr of the basal ganglia, along with many other subcortical and motor cortical inputs, which can then modulate and contextualize the motor outputs.
