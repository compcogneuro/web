...
2. _Use efficient (polynomial time) search algorithms:_ by using _dedicated-weight_ state representations and gradient-based algorithms, one can actually fight dimensionality with dimensionality! There are a number of different manifestations of this approach:
