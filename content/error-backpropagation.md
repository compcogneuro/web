...
All of the widely used modern [[abstract neural network]] models today are based primarily on backprop, including [[large language models]] (LLMs), providing a clear demonstration of the computational power of this technique, and of [[error-driven learning]] more broadly. The surprising power of this procedure provides an important case where very high dimensional spaces can be efficiently searched using a _dedicated-parallel, gradient-based_ method, as discussed further in the context of [[search]] as a universal computational framework.
